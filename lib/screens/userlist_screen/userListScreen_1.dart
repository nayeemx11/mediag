...
//   // Map<String, dynamic>? lastDocumentData; // To store the data from the last document

//   UserListScreen({required this.reegitratrionid}) {
//     print('Registration id is $reegitratrionid');
//   }
...
//         stream: db.collection('n001').snapshots(),
